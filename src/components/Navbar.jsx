...
const Navbar = () => {
  ...
  return (
    <div className={!showShadowNav ? 'fixed w-full h-[70px] flex justify-between items-center px-4 bg-gradient-to-l from-[#21073C] to-[#3A1078] text-gray-300 z-20':'fixed w-full h-[80px] flex justify-between items-center px-4 bg-gradient-to-l from-[#21073C] to-[#3A1078] text-gray-300 z-20 shadow-2xl'}>
      <div>
      ...
      <ul className="hidden md:flex">
        ...
        <li className="hover:text-[#00FFCA] hover:translate-y-1 hover:duration-200 active:text-[#00FFCA]">
          <Link to='work' smooth={true} duration={500}>Portifolio</Link>
        </li>
        <li className="hover:text-[#00FFCA] hover:translate-y-1 hover:duration-200 active:text-[#00FFCA]">
      ...
      <div className={
        ...
        >
          ...
          <li className="py-6 text-4xl hover:text-[#00FFCA] hover:translate-y-1 hover:duration-200 active:text-[#00FFCA]">
            <Link onClick={handleClick} to='work' smooth={true} duration={500}>Portifolio</Link>
          </li>
          <li className="py-6 text-4xl hover:text-[#00FFCA] hover:translate-y-1 hover:duration-200 active:text-[#00FFCA]">
